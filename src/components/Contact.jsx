...
const Contact = () => {
  ...
  return (
    <div
      className={`${styles.paddingX} xl:mt-12 gap-10 overflow-hidden`} 
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          <button
            type='submit'
            className='bg-primary py-3 px-8 rounded-xl outline-none w-fit text-black font-bold shadow-md shadow-primary'
          >
